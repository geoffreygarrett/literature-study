...
\textcolor{red}{(Short section on how CNNs refine the hypothesis of the
...
%    outside the Brillouin (i.e., circumscribing) sphere of the body.
    ...
    \textcolor{red}{(Majority of these applications are RL, short description will be here, with most in next chapter, this applies to varying degrees, to the following two points as well)}
