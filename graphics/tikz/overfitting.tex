...
\begin{minipage}[b]{0.32\textwidth}
    ...
    \end{tikzpicture}
    \caption{\small Overfitting}\label{fig:overfitting}
\end{minipage}\hfil
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{minipage}[b]{0.32\textwidth}
    \centering
    ...
    \end{tikzpicture}
    \caption{\small Underfitting}\label{fig:underfitting}
\end{minipage}\hfil
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{minipage}[b]{0.32\textwidth}
    \centering
    ...
    \end{tikzpicture}
    \caption{\scriptsize Appropriate capacity}\label{fig:balance}
\end{minipage}