...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
This section aims at a non-extensive coverage of the basics which apply to all
machine learning algorithms. Firstly a learning algorithm is described.

\subsection{Learning algorithms}
A machine learning algorithm is a procedure for learning from data. Mitchell
\cite{Mitchell97LearningAlgorithm} provides a succint definition:
\begin{quotation}
    \noindent{}"A computer program is said to learn from experience $E$ with respect to some class of
    tasks $T$ and a performance measure $P$, if its performance at tasks in $T$, as
    measured by $P$,improves with experience $E$."
\end{quotation}

The relationships between the subfield of machine learning are often unclear due to
the
